...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Kedokteran Gigi</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            <thead>
                                <tr>
                                    ...
                                    <th class='text-center'>Nama Lengkap Dokter</th>
                                    <th class='text-center'>User Dokter</th>
                                    <th class='text-center'>Password Dokter</th>
